...
<select id="ft-dialog-script" name="script" onKeyPress=onChange() onChange=onChange()>
	...
	<option value="wood"><?php _e('Wood', 'flamingtext') ?></option>
				...
				<table border="0" cellspacing="0" cellpadding="0"><tr><td><label id="font-size"><b><?php _e('Size', 'flamingtext') ?></b>: <input id="ft-dialog-fontsize" value="40" maxlength="2" size="3" onKeyPress=fontsizePressed() onChange=fontsizePressed() /></label></td><td width="200"><div id="ft-fontsizeSlider"></div></td></tr></table>
